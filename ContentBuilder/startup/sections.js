...
const snippets = [
		...
		},
		{
			...
			<div class="row">
				<div class="column fourth center"><i class="bi bi-clock-history size-32" style="color: #26a69a;"></i>
					<h3 class="leading-none tracking-wide size-18 mb-0">Duration</h3>
					<p class="pb-1" style="border-bottom: 2px solid #26a69a; display: inline-block;">6 hours</p>
				</div>
				<div class="column fourth center"><i class="bi bi-compass size-32" style="color: #26a69a"></i>
					<h3 class="leading-none tracking-wide size-18 mb-0">Activity</h3>
					<p class="pb-1" style="border-bottom: 2px solid #26a69a; display: inline-block;">Boating & Rafting</p>
				</div>
				<div class="column fourth center"><i class="bi bi-signpost-split size-32" style="color: #26a69a"></i>
					<h3 class="leading-none tracking-wide size-18 mb-0">Physical</h3>
					<p class="pb-1" style="border-bottom: 2px solid #26a69a; display: inline-block;">Challenging</p>
				</div>
				<div class="column fourth center"><i class="bi bi-geo-alt size-32" style="color: #26a69a"></i>
					<h3 class="leading-none tracking-wide size-18 mb-0">Location</h3>
					<p class="pb-1" style="border-bottom: 2px solid #26a69a; display: inline-block;">West Coast</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="column full">
					<p>Included in National Geographic Canada’s 50 Places of a Lifetime, the Discovery Islands are a sea kayaking paradise, and as you will discover, one of the West Coast’s best kept secrets. You’ll find no better sea kayaking vacation throughout remote islands on BC’s central coast.</p>
					<p>Comprised of a dozen islands in the Discovery Passage between Vancouver Island and the mainland in British Columbia, we will take you kayaking throughout this sparsely inhabited remote group of islands on this kayaking tour.</p>
					<p>Paddling around the islands provides the ideal way to get close to nature and be completely enveloped in the beauty of towering trees, remote beaches, and mountains. Discover the wildlife that inhabit this region and the secrets of British Columbia’s rich and plentiful inter-tidal life while exploring magical waterways.</p>
				</div>
			</div>
			
			<div class="row">
				<div class="column full">
					<h5 class="font-normal">Tour highlights</h5>
					<ul>
			...
			<div class="row">
				<div class="column half flex flex-col justify-start">
					<h5 class="font-normal">What's included</h5>
					<p class="d-inline-block my-1"><span class="svg-check"></span>Entrance ticket for the Pantheon</p>
					<p class="d-inline-block my-1"><span class="svg-check"></span>Digital audio guide on your smartphone</p>
				</div>
				<div class="column half flex flex-col justify-start">
					<h5 class="font-normal">What's not included</h5>
					<p class="d-inline-block my-1"><span class="svg-delete"></span>Live tour guide</p>
					<p class="d-inline-block my-1"><span class="svg-delete"></span>Headphones</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="column full">
					<h5 class="font-normal">Tour Plan</h5>
					<label class="accordion-wrapper">
					  <input type="checkbox" class="accordion" hidden />
					  <div class="title">
						<strong>South Iceland</strong>
							<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" title="angle-right" class="side-icon">
								<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
								<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
								<g id="SVGRepo_iconCarrier">
									<rect width="24" height="24" fill="white"></rect>
									<path d="M9.5 7L14.5 12L9.5 17" stroke="#777777" stroke-linecap="round" stroke-linejoin="round"></path>
								</g>
							</svg>
							<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(90)" height="32" title="angle-down" class="down-icon">
								<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
								<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
								<g id="SVGRepo_iconCarrier">
									<rect width="24" height="24" fill="white"></rect>
					  ...
					  <div class="content">
						<p>Pick up your rental car at Keflavik airport upon arrival. Visit the spectacular Blue Lagoon Geothermal Spa on the way from Keflavik International Airport (depending on your arrival time). Head along the South Shore road and stop by the pretty coastal villages of Stokkseyri and Eyrarbakki. Continue towards Hveragerði town where nearby Eldhestar and Sólhestar offer horseback riding tours in a landscape of lava fields, natural hot springs, volcanoes and mountains.</p>
					  </div>
					</label>
					<label class="accordion-wrapper">
					  <input type="checkbox" class="accordion" hidden />
					  <div class="title">
						<strong>Vatnajökull National Park</strong>
							<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" title="angle-right" class="side-icon">
								<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
								<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
								<g id="SVGRepo_iconCarrier">
					  ...
					  <div class="content">
						<p>Continue to Skaftafell which part of Vatnajökull national park, with its beautiful contrasting landscapes of glaciers, black sands and lush green valleys. View the spectacular Jökulsárlón Glacier Lagoon. You can also opt to take an adventurous snowmobile tour on Mýrdalsjökull Glacier.</p>
					  </div>
					</label>
					<label class="accordion-wrapper">
					  <input type="checkbox" class="accordion" hidden />
					  <div class="title">
						<strong>Reykjavik Area</strong>
							<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="32" title="angle-right" class="side-icon">
								<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
								<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
								<g id="SVGRepo_iconCarrier">
					  ...
					  <div class="content">
						<p>Enjoy spending the last day of your trip in Reykjavik, the capital city. Reykjavik is a safe, clean, and vibrant city that has great museums, historic attractions, galleries, shops, open-air geothermal swimming pools and much more - so there is something for all to enjoy. While exploring the city, a taste of delicious Icelandic cuisine can be found in a variety of exciting restaurants located all over the city.</p>
					  </div>
					</label>
				</div>
			</div>
			...
			<!-- Tour Timeline from \archive TEMPLATES misc\Travel Templates\panagea -->
			<div class="row">
			    <div class="column full position-relative">
			        <div class="timelinerotate d-none d-lg-block"><p class="size-50">journey timeline</p></div>
					<ul class="cbp_tmtimeline snipcss-DQLt7">
						<li class="">
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="images/tour_1.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
								<h4>Arc de Triomphe</h4>
								<p> Vero consequat cotidieque ad eam. Ea duis errem qui, impedit blandit sed eu. Ius diam vivendo ne. </p>
							</div>
						</li>
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="images/tour_2.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
						...
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="images/tour_3.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
						...
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="images/tour_4.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
								<h4>Eiffel Tower fresco</h4>
								<p> Vero consequat cotidieque ad eam. Ea duis errem qui, impedit blandit sed eu. Ius diam vivendo ne. </p>
							</div>
						</li>
					</ul>
			...
			<div class="row">
				<div class="column full">
			        <h5 class="font-normal mb-1">Tour map</h5>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m32!1m8!1m3!1d13929.338600828665!2d-21.8425636!3d64.1254191!3m2!1i1024!2i768!4f13.1!4m21!3e2!4m3!3m2!1d64.13476299999999!2d-21.8388729!4m3!3m2!1d64.13169239999999!2d-21.8324356!4m3!3m2!1d64.1271233!2d-21.8375854!4m3!3m2!1d64.1245763!2d-21.8411045!4m3!3m2!1d64.1210176!2d-21.840417799999997!5e0!3m2!1sen!2sde!4v1726285366294!5m2!1sen!2sde" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
				</div>
			</div>`
        },
		...
		{
		    'image': 'preview/basic-05.png',
		    'category': '120',
		    'html': `
			<img src="../${Vvveb.themeBaseUrl}images/img-2400x1350.png" alt="">
			`	
		},
        {
		    'image': 'preview/basic-24.png',
		    'category': '120',
		    'html': `
			<div class="row">
                <div class="column">
		...
		{
		    'image': 'preview/basic-21.png',
		    'category': '120',
			'mode': 'canvas',
		    'html': `
			<div class="is-block block-steady" style="top: 20%; left: 20%; width:540px;height: 300px" data-new-dummy="1">
				<div class="is-block-overlay" style="background-image: url(&quot;../${Vvveb.themeBaseUrl}images/img-2400x1350.png"&quot;); background-position: 50% 60%;"></div>
			</div>
			`,
			'html2': `
			<div class="row">
		...
		//     'category': '120',
		//     'html': `
		// 	<img src="../${Vvveb.themeBaseUrl}images/office2.png" alt="">
		// 	`	
		// },
		// {
		//     'image': 'preview/basic-21.png',
		...
		//     'html': `
		// 	<div class="is-block block-steady" style="top: 20%; left: 20%; width:540px;height: 300px" data-new-dummy="1">
		// 		<div class="is-block-overlay" style="background-image: url(&quot;../${Vvveb.themeBaseUrl}images/person2.png&quot;); background-position: 50% 60%;background-color: rgb(254, 243, 226);"></div>
		// 	</div>
		// 	`	
		// },
		...
		{
		    'image': 'preview/basic-23.png',
		    'category': '120',
		    'html': `
			<div class="row">
				<div class="column full">
					<h1 class="font-semibold size-42 tracking-wider">Agency Name — We imagine, ideate, and execute with intention and drive to discover new ways of designing and detailing spaces.</h1>
				</div>
			</div>
			<div class="row">
				<div class="column full">
        ...
        {
		    'image': 'preview/gallery-01.png',
		    'category': '120',
		    'html': `
				<div class="row">
                    <div class="column full padding-0" data-noedit 
                    data-dialog-width="1200px" 
                    data-dialog-height="740px" 
                    data-module="media-grid-builder" 
                    data-module-desc="Image Gallery" 
                    data-html="
                            ...
                            <div id="{id}" class="is-media-grid grid-sortable" style="opacity:0">
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-01.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-01.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-02.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-02.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-03.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-03.jpg" alt="">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-04.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-04.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-06.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-06.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-05.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-05.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-07.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-07.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-08.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-08.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="../${Vvveb.themeBaseUrl}images/img-09.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="../${Vvveb.themeBaseUrl}images/img-09.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
		...
		*/
		...
		{
		    'image': 'preview/basic-12.png',
		    'category': '120',
		    'html': `
			<div class="row">
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
		...
		/* elements */
		{
		    'image': 'preview/basic-textslider.png',
		    'category': '120',
			'type': 'glide',
		    'html': `
			<div class="row">
		...
		{
		    'image': 'preview/basic-youtube.png',
		    'category': '120',
		    'html': `
				<div class="embed-responsive embed-responsive-16by9">
		...
		{
		    'image': 'preview/basic-video.png',
		    'category': '120',
		    'html': `
			<video style="width: 100%;" loop="" autoplay="">
				<source src="../${Vvveb.themeBaseUrl}example.mp4" type="video/mp4">
			</video>
			`	
		},
		{
		    'image': 'preview/basic-slider.png',
		    'category': '120',
			'type': 'slick',
		    'html': 
				'<div class="row">' +
                    '<div class="column full" data-noedit data-module="slider" data-module-desc="Slider" data-html="' +
                        ...
                        encodeURIComponent('<div id="{id}" class="slider-on-content" style="position:absolute;top:0;left:0;width:100%;height:100%;display:none">' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'../${Vvveb.themeBaseUrl}images/slide1.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'../${Vvveb.themeBaseUrl}images/slide2.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'../${Vvveb.themeBaseUrl}images/slide3.jpg\');">' +
                            '</div>' +
                        '</div>' +
                        '' +
                        '<scr' + 'ipt>' +
                        ...
                        encodeURIComponent('[' +
                                '{' +
                                    ...
                                    '"images":' +
                                        '[' +
                                            '{' +
                                                '"src": "../${Vvveb.themeBaseUrl}images/slide1.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "../${Vvveb.themeBaseUrl}images/slide2.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "../${Vvveb.themeBaseUrl}images/slide3.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '}' +
                                        ']' +
                                '}]') + '"' +
									...
									<div data-glide-el="track" class="glide__track">
										<ul class="glide__slides">
											<li class="glide__slide">
												<div data-subblock><img data-image-embed data-noresize data-sync src="../${Vvveb.themeBaseUrl}images/travel2.png" alt="" /></div>
											</li>
											<li class="glide__slide">
												<div data-subblock><img data-image-embed data-noresize data-sync src="../${Vvveb.themeBaseUrl}images/travel.png" alt="" /></div>
											</li>
										</ul>
									</div>
		...
		{
		    'image': 'preview/basic-14.png',
		    'category': '120',
		    'html': `
			<div class="row">
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt=""></div>
				<div class="column half">
					<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				</div>
			</div>
		...
		},
		{
			...
			<div class="row">
				<div class="column third">
					...
					<h3 class="tracking-wide size-24">Feature One</h3>
				...
				<div class="column third">
					...
					<h3 class="tracking-wide size-24">Feature Two</h3>
					<p>Lorem Ipsum is simply dummy text of the printing industry.</p>
				</div>
				<div class="column third">
					<div class="rounded-full flex justify-center items-center mb-8" style="width: 40px;height: 40px;border: 2px solid rgb(136, 136, 136);">
					...
					<h3 class="tracking-wide size-24">Feature Three</h3>
					<p>Lorem Ipsum is simply dummy text of the printing industry.</p>
				</div>
			</div>
			`	
		...
		{
		    'image': 'preview/basic-20.png',
		    'category': '120',
		    'html': '<hr>'
		},

		{
		    'image': 'preview/basic-code.png',
		    'category': '120',
		    'html': `
			<div class="row">
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="flex flex-col justify-center items-center column two-third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/article-04.png',
		    'category': '118',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/article-07.png',
		    'category': '118',
		    'html': `
			<div class="row relative sm-items-1">
				<div class="flex flex-col justify-center items-center column two-third" style="width: 100%;"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt="" style="width: 99.9136%; height: auto;"></div>
		...
		{
		    'image': 'preview/article-13.png',
		    'category': '118',
		    'html': `
			<div class="row relative sm-items-2">
				<div style="width: 42.6729%; flex: 0 0 auto;" class="column half flex flex-col justify-end pb-3"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="column half flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/headline-07.png',
		    'category': '101',
		    'html': `
			<div class="row">
				...
				<div style="position: relative; width: 59%; flex: 0 0 auto;" class="flex flex-col justify-center column half">
					<div class="is-dock">
						<div style="width: 90%;left: 15%;top: 19%;min-width:400px">
							...
							<img alt="" data-noresize="" src="../${Vvveb.themeBaseUrl}images/img-2400x1350.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(130px);" data-center-top="transform: translateX(0px);" data-50-top="transform: translateX(0px);" data-top-bottom="transform: translateX(125px);">
						</div>
						<div style="width: 92%;left: 41%;top: 41%;">
							<img alt="" data-noresize="" src="../${Vvveb.themeBaseUrl}images/bg2-1920x1080.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(100px);" data-center-top="transform: translateX(0px);" data-50-top="transform: translateX(0px);" data-top-bottom="transform: translateX(100px);">
						</div>
					</div>
				</div>
				...
				<div style="position: relative; min-height: 30vh; width: 59%; flex: 0 0 auto;" class="flex flex-col justify-center items-center column third">
					<div class="is-dock" style="margin:50px 0">
						<div style="width: 120%;left: 40%;top: 4%;">
							<img alt="" data-noresize="" src="../${Vvveb.themeBaseUrl}images/img-2400x1350.png" style="width: 100%;" data-bottom-top="transform: translateX(130px);" data-center="transform: translateX(0px);">
						</div>
						<div style="width: 58%;left: 13%;top: 56%;">
							<img alt="" data-noresize="" src="../${Vvveb.themeBaseUrl}images/bg2-1920x1080.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(75px);" data-center-top="transform: translateX(0px);" data-center-bottom="transform: translateX(0px);" data-top-bottom="transform: translateX(75px);">
						</div>
						<div style="width: 58%;left: 89%;top: 56%;">
							<img alt="" data-noresize="" src="../${Vvveb.themeBaseUrl}images/bg2-1920x1080.png" style="width: 100%; box-shadow: rgba(22, 22, 22, 0.2) 3em 3em 5em;" data-bottom-top="transform: translateX(125px);" data-center-top="transform: translateX(0px);" data-center-bottom="transform: translateX(0px);" data-top-bottom="transform: translateX(100px);">
						</div>
					</div>
				</div>
...
"><i class="icon ion-android-arrow-dropright-circle mr-3 size-50"></i> Show Reel</a>
		...
		/* Photos */
		{
		    'image': 'preview/photos-01.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
			</div>
			`	
		},
		{
		    'image': 'preview/photos-02.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="" style="margin: 0;float: left;"></div>
			</div>
			`	
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column two-third"><img src="../${Vvveb.themeBaseUrl}images/img-1920x1280.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/photos-05.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="column two-third"><img src="../${Vvveb.themeBaseUrl}images/img-1920x1280.png" alt=""></div>
		...
		{
		    'image': 'preview/photos-06.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="column half">
					<p class="text-center">Example One</p><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
				</div>
				<div class="column half">
					<p class="text-center">Example Two</p><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
				</div>
			</div>
			`	
		},
		...
		{
		    'image': 'preview/photos-14.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="column half">
					<img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
		...
		},
		{
		    ...
		    'html': `
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
		...
		{
		    'image': 'preview/photos-08.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div class="pr-8 column half"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt="">
		...
		{
		    'image': 'preview/photos-09.png',
		    'category': '102',
		    'html': `
			<div class="row">
				<div style="width: 73.7397%; flex: 0 0 auto;" class="column two-fourth"><img src="../${Vvveb.themeBaseUrl}images/img-1600x1200.png" alt=""></div>
		...
		{
		    'image': 'preview/photos-11.png',
		    'category': '102',
		    'html': `
			<div class="row sm-autofit md-autofit">
				<div style="width: 38.7637%; flex: 0 0 auto;" class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
				...
				<div style="width: 100%;" class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">

					<h2 class="font-normal size-21">Project Two</h2>
					<p>Lorem Ipsum is simply dummy text of the printing.</p>
				</div>
				<div class="column fourth" style="width: 100%;"><img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">
		...
		/* Profile */
		{
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column third px-3">
					<div class="img-circular" style="margin:25px 0 0;width: 10vw;height: 10vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="../${Vvveb.themeBaseUrl}images/img-700x700.png" alt=""></div>
		...
		},
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="flex flex-col justify-center items-center column two-third">
					<img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt="">
				</div>
			</div>
		</div>
			`	
		},
		{
			...
			<div class="row">
				<div class="column third center flex flex-col justify-start items-center"><img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">
				...
				<div class="column third center flex flex-col justify-start items-center">
					<img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">
		...
		},
		{
			...
			<div class="row">
				<div class="column third py-4"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
		...
		},
		{
			...
			<div class="row">
				<div class="text-right column third flex flex-col justify-center items-center">
					<div class="img-circular" style="margin:25px 0;width: 13vw;height: 13vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="../${Vvveb.themeBaseUrl}images/img-700x700.png" alt=""></div>
				</div>
		...
		{
		    'image': 'preview/profile-08.png',
		    'category': '103',
		    'html': `
			<div class="row">
				<div class="flex flex-col justify-center items-center px-3 column third py-3">
					<div class="img-circular" style="width: 10vw;height: 10vw;min-width:150px;min-height:150px;"><img style="height: 100%; width: 100%; object-fit: cover" src="../${Vvveb.themeBaseUrl}images/img-700x700.png" alt=""></div>
				</div>
		...
		},
		{
			...
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt="">
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1200x675.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/profile-11.png',
		    'category': '103',
		    'html': `
			<div class="row">
				<div class="center column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
		...
		{
		    'image': 'preview/profile-12.png',
		    'category': '103',
		    'html': `
			<div class="row">
				<div class="column half flex flex-col justify-end items-start"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt=""></div>
		...
		/* Products */
		{
			...
			<div class="row relative sm-items-1">
				...
				<div class="flex flex-col justify-center items-center column half" style="width: 59.4737%; flex: 0 0 auto;"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/products-03.png',
		    'category': '104',
		    'html': `
			<div class="row">
		...
		},
		{
			...
			<div class="row">
				<div class="py-4 column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
		...
		},
		{
			...
			<div class="row relative sm-items-2">
			<div class="column third py-4"><img src="../${Vvveb.themeBaseUrl}images/img-900x900.png" alt="">
		...
		{
		    'image': 'preview/products-02.png',
		    'category': '104',
		    'html': `
			<div class="row relative sm-items-1">
				<div class="flex flex-col justify-center items-center column half" style="width: 58.0263%; flex: 0 0 auto;"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
				<div class="py-6 column half" style="width: 100%;">
		...
		},
		{
			...
			<div class="row relative sm-items-2">
				<div class="column fourth py-4"><img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">
		...
		/*
		{
			...
			<div class="row relative md-items-2 sm-items-2">
				<div style="width: 27.4233%; flex: 0 0 auto;" class="column fourth pb-4"><img src="../${Vvveb.themeBaseUrl}images/img-900x1350.png" alt=""></div>
				...
				<div class="column fourth pb-4" style="width: 27.4847%; flex: 0 0 auto;"><img src="../${Vvveb.themeBaseUrl}images/img-900x1350.png" alt=""></div>
		...
		*/
		{
			...
			<div class="row relative sm-items-2">
				<div class="column fourth flex flex-col justify-end py-4"><img src="../${Vvveb.themeBaseUrl}images/img-900x900.png" alt="">
				...
				<div class="column fourth flex flex-col justify-end py-4"><img src="../${Vvveb.themeBaseUrl}images/img-900x600.png" alt="">
				...
				<div class="column fourth flex flex-col justify-end py-4"><img src="../${Vvveb.themeBaseUrl}images/img-678x904.png" alt="">
				...
				<div class="column fourth flex flex-col justify-end py-4"><img src="../${Vvveb.themeBaseUrl}images/img-900x1350.png" alt="">
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half" style="width: 60.4651%; flex: 0 0 auto;"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-20"></div>
		...
		{
		    'image': 'preview/products-11.png',
		    'category': '104',
		    'html': `
			<div class="row">
				<div class="column"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half" style="width: 53.5526%; flex: 0 0 auto;"><img src="../${Vvveb.themeBaseUrl}images/img-1350x1350.png" alt=""></div>
			</div>
			`	
		},
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-40"></div>
		...
		/* Achievements */
		{
		    'image': 'preview/achievements-01.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-02.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column third">
		...
		{
		    'image': 'preview/achievements-03.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-04.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-05.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column half">
		...
		{
		    'image': 'preview/achievements-06.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-07.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-08.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/achievements-09.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div style="width: 40%; flex: 0 0 auto;" class="column half">
		...
		{
		    'image': 'preview/achievements-10.png',
		    'category': '109',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/quotes-03.png',
		    'category': '110',
		    'html': `
			<div class="row">
				<div class="column two-third"><img src="../${Vvveb.themeBaseUrl}images/img-1920x1080.png" alt="""></div>
		...
		},
		{
			...
			<div class="row">
				<div class="text-center flex flex-col justify-center items-center column third"><img src="../${Vvveb.themeBaseUrl}images/img-700x700.png" alt="" style="border-radius: 500px; width: 65%; height: auto;">
					<div class="spacer height-20"></div>
		...
		},
		{
			...
			<div class="row">
				<div class="text-center flex flex-col justify-center items-center column third"><img src="../${Vvveb.themeBaseUrl}images/img-1350x900.png" alt="">
					<div class="spacer height-20"></div>
					<div class="text-center">
						<i class="icon ion-quote size-28"></i>
					</div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1500x2000.png" alt=""></div>
		...
		/* Partners */
		{
			...
			<div class="row sm-autofit">
				...
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/creative.png" alt=""></div>
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/steady.png" alt=""></div>
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/light-studio.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column full">
					<div class="spacer height-20"></div>
			...
			<div class="row sm-autofit">
				...
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/infinitech.png" alt=""></div>
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/design-firm.png" alt=""></div>
				<div class="column fourth"><img src="../${Vvveb.themeBaseUrl}images/sitepro.png" alt=""></div>

			</div>
			`	
		},
		{
		    'image': 'preview/partners-02.png',
		    'category': '111',
		    'html': `
			<div class="row">
				<div class="column full text-center">
			...
			<div class="row">
				<div class="column third flex flex-col justify-center items-center">
					<img src="../${Vvveb.themeBaseUrl}images/creative.png" alt="">
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<img src="../${Vvveb.themeBaseUrl}images/light-studio.png" alt="">
				</div>
				<div class="column third flex flex-col justify-center items-center">
					<img src="../${Vvveb.themeBaseUrl}images/infinitech.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row">
				...
				<div class="column fourth flex flex-col justify-center items-center" style="width: 100%;">
					<img src="../${Vvveb.themeBaseUrl}images/infinitech.png" alt="">
					<div class="spacer height-20"></div><img src="../${Vvveb.themeBaseUrl}images/light-studio.png" alt="">
				</div>
				<div class="column fourth flex flex-col justify-center items-center" style="width: 100%;">
					<img src="../${Vvveb.themeBaseUrl}images/steady.png" alt="">
					<div class="spacer height-20"></div><img src="../${Vvveb.themeBaseUrl}images/sitepro.png" alt="">
				</div>
		...
		},
		{
			...
			<div class="row">
				<div class="column fifth"><img src="../${Vvveb.themeBaseUrl}images/creative.png" alt=""></div>
				<div class="column fifth"><img src="../${Vvveb.themeBaseUrl}images/steady.png" alt=""></div>
				<div class="column fifth"><img src="../${Vvveb.themeBaseUrl}images/light-studio.png" alt=""></div>
				<div class="column fifth"><img src="../${Vvveb.themeBaseUrl}images/design-firm.png" alt=""></div>
				<div class="column fifth"><img src="../${Vvveb.themeBaseUrl}images/sitepro.png" alt=""></div>

			</div>
			`	
		},
		{
		    'image': 'preview/partners-05.png',
		    'category': '111',
		    'html': `
			<div class="row">
				<div class="column full">
			...
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/worldwide.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/steady.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/design-firm.png" alt=""></div>

			</div>
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/infinitech.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/light-studio.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/upclick.png" alt=""></div>
		...
		/* As Featured On */
		{
		    'image': 'preview/asfeaturedon-01.png',
		    'category': '112',
		    'html': `
			<div class="row">
				<div class="column full">
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column fifth"><img src="../${Vvveb.themeBaseUrl}images/upclick.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="../${Vvveb.themeBaseUrl}images/digitalmag.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="../${Vvveb.themeBaseUrl}images/mmedia.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="../${Vvveb.themeBaseUrl}images/bbuzz.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column fifth"><img src="../${Vvveb.themeBaseUrl}images/prosource.png" alt=""></div>

			</div>
			`	
		},
		{
		    'image': 'preview/asfeaturedon-02.png',
		    'category': '112',
		    'html': `
			<div class="row">
				...
				<div class="column fifth flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/onesight.png" alt=""></div>
				<div class="column fifth flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/mmedia.png" alt=""></div>
				<div class="column fifth flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/digitalmag.png" alt=""></div>

			</div>
			`	
		},
		{
		    'image': 'preview/asfeaturedon-03.png',
		    'category': '112',
		    'html': `
			<div class="row sm-autofit">
			...
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/upclick.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/digitalmag.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/mmedia.png" alt=""></div>
			</div>
			<div class="row">
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/prosource.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/worldwide.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/bbuzz.png" alt=""></div>
			</div>
			`	
		},
		{
		    'image': 'preview/asfeaturedon-04.png',
		    'category': '112',
		    'html': `
			<div class="row">
				<div class="column full">
			...
			<div class="row">
				<div class="flex flex-col justify-center items-center column third"><img src="../${Vvveb.themeBaseUrl}images/upclick.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column third"><img src="../${Vvveb.themeBaseUrl}images/digitalmag.png" alt=""></div>
				<div class="flex flex-col justify-center items-center column third"><img src="../${Vvveb.themeBaseUrl}images/mmedia.png" alt=""></div>

			</div>

			<div class="row">
				<div class="column third flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/prosource.png" alt=""></div>

				<div class="column third flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/nett.png" alt=""></div>
				<div class="column third flex flex-col justify-center items-center"><img src="../${Vvveb.themeBaseUrl}images/worldwide.png" alt=""></div>
		...
		/* Coming Soon */
		{
		    'image': 'preview/comingsoon-01.png',
		    'category': '114',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		{
		    'image': 'preview/comingsoon-02.png',
		    'category': '114',
		    'html': `
			<div class="row">
				<div class="column full center">
		...
		{
		    'image': 'preview/comingsoon-03.png',
		    'category': '114',
		    'html': `
			<div class="row">
		...
		{
		    'image': 'preview/comingsoon-04.png',
		    'category': '114',
		    'html': `
			<div class="row">
				<div class="column full center">
		...
		{
		    'image': 'preview/comingsoon-05.png',
		    'category': '114',
		    'html': `
			<div class="row">
				<div class="column full">
		...
		},
		{
			...
			<div class="row">
				<div class="column full"><img src="../${Vvveb.themeBaseUrl}images/img-1600x600.png" alt=""></div>
			</div>
			<div class="row">
		...
		/*  About */
		{
			...
			<div class="row">
                ...
                <div class="row">
                    <div class="column third"><img src="../${Vvveb.themeBaseUrl}images/sitepro.png" alt="" style="margin: 0;"></div>
                    <div class="column two-third">
		...
		
		{
			...
			<div class="row">
				...
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt=""></div>
				<div class="column third"><img src="../${Vvveb.themeBaseUrl}images/img-1200x1600.png" alt=""></div>
		...
		
		{
			...
			<div class="row">
				<div class="column half"><img src="../${Vvveb.themeBaseUrl}images/img-1920x1080.png" alt=""></div>
				<div class="column half">
					<p class="text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type.</p>
				</div>
        ...
        {
		'image': 'preview/element-module.png',
		'category': '120',
		'html':
			    '<div class="row">' +
                    '<div class="column full" data-noedit data-module="my-custom-module" data-module-desc="My Module" data-html="' + // module file will be: assets/modules/my-custom-module.html
        ...
        {
		'image': 'preview/element-ajax.png',
		'category': '120',
		'html':
			    '<div class="row">' +
		...
		*/
		...
		{
			'image': 'preview/basic-codeview.png',
			'category': '120',
			'html':
				`<div class="row">
