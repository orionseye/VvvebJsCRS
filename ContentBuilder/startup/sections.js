...
Vvveb.Sections.add("hero/hero-1", {
    name: "Hero 1",
    image: Vvveb.themeBaseUrl + "/screenshots/dimi-00.png",
    html: `<section><div class="row">
			...
			<div class="row">
				<div class="col-4 center"><i class="bi bi-clock-history size-32" style="color: #26a69a;"></i>
				...
				<div class="col-4 center"><i class="bi bi-compass size-32" style="color: #26a69a"></i>
				...
				<div class="col-4 center"><i class="bi bi-signpost-split size-32" style="color: #26a69a"></i>
				...
				<div class="col-4 center"><i class="bi bi-geo-alt size-32" style="color: #26a69a"></i>
			...
			<div class="row">
			    <div class="col-12 d-flex justify-content-start shadow-1" style="max-width: 770px; padding: 0.8em; border-radius: 0.75rem !important;">
					<div class="col-9">
					...
					<div class="col-3 d-inline-flex justify-content-start align-items-center">
						...
						<img style="height: 100%; width: 100%; object-fit: cover" src="assets/minimalist-blocks/images/travel.png" alt=""></div>
					</div>
				</div>
			</div>
					...
					<ul class="cbp_tmtimeline snipcss-DQLt7">
						<li class="">
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="assets/minimalist-blocks/images/tour_1.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
						...
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="assets/minimalist-blocks/images/tour_2.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
						...
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="assets/minimalist-blocks/images/tour_3.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
						...
						<li>
							...
							<div class="cbp_tmlabel">
								<div class="hidden-xs">
									<img src="assets/minimalist-blocks/images/tour_4.jpg" alt="" class="rounded-circle thumb_visit">
								</div>
    ...
    name: "Flex Columns x3 with gaps",
    image: Vvveb.themeBaseUrl + "/screenshots/sections/hero/hero-2-thumb.jpeg",
    html: `<section title="three columns" class="py-4">
<div style="display: flex; flex-direction: row; gap: 20px; padding: 20px; border: 2px solid #ccc;">
    <div style="display: flex; flex-direction: column; gap: 10px; padding: 15px; background: #f9f9f9; border: 1px solid #ddd; flex: 1;">
        <div style="padding: 15px; background: #ffcccc; border: 1px solid #ff9999;">Column 1 - Item 1</div>
        <div style="padding: 15px; background: #ffddcc; border: 1px solid #ffaa99;">Column 1 - Item 2</div>
        <div style="padding: 15px; background: #ffeecc; border: 1px solid #ffbb99;">Column 1 - Item 3</div>
    </div>
    
    <div style="display: flex; flex-direction: column; gap: 10px; padding: 15px; background: #f9f9f9; border: 1px solid #ddd; flex: 1;">
        <div style="padding: 15px; background: #ccffcc; border: 1px solid #99ff99;">Column 2 - Item 1</div>
        <div style="padding: 15px; background: #ddffcc; border: 1px solid #aaff99;">Column 2 - Item 2</div>
        <div style="padding: 15px; background: #eeffcc; border: 1px solid #bbff99;">Column 2 - Item 3</div>
    </div>
    
    <div style="display: flex; flex-direction: column; gap: 10px; padding: 15px; background: #f9f9f9; border: 1px solid #ddd; flex: 1;">
        <div style="padding: 15px; background: #ccccff; border: 1px solid #9999ff;">Column 3 - Item 1</div>
        <div style="padding: 15px; background: #ddccff; border: 1px solid #aa99ff;">Column 3 - Item 2</div>
        <div style="padding: 15px; background: #eeccff; border: 1px solid #bb99ff;">Column 3 - Item 3</div>
    </div>
</div>
		</section>`
});Vvveb.Sections.add("hero/hero-3", {
    name: "Flex Column Single with gap",
...
<div style="display: flex; flex-direction: column; gap: 20px; padding: 20px; border: 2px solid #ccc;">
    ...
    name: "3 Dimi Flex columns with IncrDecr-flag",
...
<div class="IncrDecr-flag" style="display: flex; flex-direction: row;">
    <div style="flex: 0 0 50%; padding: 20px; background: #ffcccc; border: 1px solid #ff9999;">Column 1 (50%)</div>
    <div style="flex: 0 0 50%; padding: 20px; background: #ccffcc; border: 1px solid #99ff99;">Column 2 (50%)</div>
</div>
...
Vvveb.Sections.add("hero/hero-5", {
    name: "3 different Bootstrap Flex columns",
    image: Vvveb.themeBaseUrl + "/screenshots/sections/hero/hero-4-thumb.jpeg",
    html: `<section title="three columns" class="py-4">
<!-- Bootstrap col-* classes -->
<div class="row">
    <div class="col-6" style="padding: 20px; background: #ffcccc; border: 1px solid #ff9999;">Column 1 (col-6)</div>
    <div class="col-6" style="padding: 20px; background: #ccffcc; border: 1px solid #99ff99;">Column 2 (col-6)</div>
</div>

<!-- Bootstrap col-4 (3 columns) -->
<div class="row">
    <div class="col-4" style="padding: 20px; background: #ffcccc; border: 1px solid #ff9999;">Column 1 (col-4)</div>
    <div class="col-4" style="padding: 20px; background: #ccffcc; border: 1px solid #99ff99;">Column 2 (col-4)</div>
    <div class="col-4" style="padding: 20px; background: #ccccff; border: 1px solid #9999ff;">Column 3 (col-4)</div>
</div>

<!-- Mixed Bootstrap cols -->
<div class="row">
    <div class="col-3" style="padding: 20px; background: #ffcccc; border: 1px solid #ff9999;">Column 1 (col-3)</div>
    <div class="col-9" style="padding: 20px; background: #ccffcc; border: 1px solid #99ff99;">Column 2 (col-9)</div>
</div>
</section>`
