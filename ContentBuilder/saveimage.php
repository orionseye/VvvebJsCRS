<?php
/********** CRS RELATED CONFIGURATION *******************/
// 
include_once("session.php");

// retrieved from editor.php
$sID = $_SESSION['sID']; 
...
//$path = 'uploads/'; 
$path =  USER_DATA.'standalone'.SEP.$sID.'/editor/';
...
if ($success === FALSE) {
  ...
  echo "<html><body onload=\"parent.document.getElementById('img-" . $count . "').setAttribute('src','" . FILE_SAVE_PATH . 'standalone/' . $sID . '/editor/' . $image . "');  parent.document.getElementById('img-" . $count . "').removeAttribute('id') \"></body></html>";
}
